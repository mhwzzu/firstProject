...
public class DecisionController {
    ...
    @GetMapping("/wishes") public List<WishResponse> wishes(HttpServletRequest request){Long user=sessions.requireUserId(request);CoupleSpace space=spaces.requireCurrentSpace(user);return decisions.wishes(user,space.getId());}
